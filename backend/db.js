...
const TABLE_DEFS = {
  users: `_id TEXT PRIMARY KEY, fullName TEXT, username TEXT, email TEXT, password TEXT, role TEXT, status TEXT, trackingCode TEXT, created_at TEXT, phone TEXT, building TEXT, locality TEXT, region TEXT, city TEXT, area TEXT, address TEXT, division TEXT, district TEXT, thana TEXT`,
  links: `_id TEXT PRIMARY KEY, category TEXT, trackingCode TEXT, pageUrl TEXT, buttonName TEXT, location TEXT, total_clicks INTEGER DEFAULT 0, created_at TEXT`,
  sessions: `_id TEXT PRIMARY KEY, trackingCode TEXT, visitorId TEXT, ip TEXT, browser TEXT, deviceType TEXT, status TEXT, isLive INTEGER DEFAULT 0, entryUrl TEXT, currentUrl TEXT, lastActivity TEXT, clicks INTEGER DEFAULT 0, userName TEXT, formData TEXT, adminStatus TEXT, lastMessage TEXT, timestamp TEXT`,
  trash: `_id TEXT PRIMARY KEY, trackingCode TEXT, originalId TEXT, activity TEXT, systemData TEXT, deletedAt TEXT`,
  menuItems: `_id TEXT PRIMARY KEY, buttonName TEXT, pageUrl TEXT, location TEXT, created_at TEXT`,
  routeLogs: `_id TEXT PRIMARY KEY, visitorId TEXT, changedBy TEXT, oldUrl TEXT, newUrl TEXT, changedAt TEXT`,
  clicks: `_id TEXT PRIMARY KEY, trackingCode TEXT, visitorId TEXT, ip TEXT, clickedAt TEXT`,
  products: `_id TEXT PRIMARY KEY, name TEXT, brand TEXT, price REAL, originalPrice REAL, condition TEXT, specs TEXT, rating REAL, image TEXT, images TEXT, color TEXT, deviceColor TEXT, screenSize TEXT, ram TEXT, storage TEXT, batteryHealth TEXT, warranty TEXT, returnPolicy TEXT, description TEXT, views INTEGER DEFAULT 0, created_at TEXT`,
  comments: `_id TEXT PRIMARY KEY, productId TEXT, name TEXT, text TEXT, created_at TEXT`,
  orders: `_id TEXT PRIMARY KEY, userId TEXT, productName TEXT, productId TEXT, productImage TEXT, productSpecs TEXT, productColor TEXT, price REAL, paymentMode TEXT, paymentStatus TEXT DEFAULT 'pending', address TEXT, created_at TEXT`
};
...
async function initDB() {
  for (const [table, def] of Object.entries(TABLE_DEFS)) {
    try {
      ...
      await client.execute(`CREATE TABLE ${table} (${def})`);
      console.log(`Table ${table} ready`);
    } catch (e) { console.error(`Table ${table} error:`, e.message); }
  }
